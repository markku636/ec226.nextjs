...
export default function PrivacyPage() {
    ...
    return (
        <>
            ...
            <div className="px-4 mt-12 border-b border-gray-200 lg:mt-14 xl:mt-16 lg:py-1 xl:py-0 md:px-10 lg:px-7 xl:px-16 2xl:px-24 3xl:px-32 pb-9 md:pb-14 lg:pb-16 2xl:pb-20 3xl:pb-24">
                <Container>

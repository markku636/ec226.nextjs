...
const FeatureBlock: React.FC<Props> = ({ className = 'mb-12 md:mb-14 xl:mb-16' }) => {
    return (
        <div
            className={`${className} bg-gray-100 feature-block-wrapper border border-gray-200 rounded-md w-full grid grid-cols-1 sm:grid-cols-2 xl:grid-cols-4 gap-10 md:gap-12 xl:gap-0 overflow-hidden py-12 xl:py-0 sm:px-4 md:px-8 lg:px-16 xl:px-0`}
        >
            {data?.map((item) => (
